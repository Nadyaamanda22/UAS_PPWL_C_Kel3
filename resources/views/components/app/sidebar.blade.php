<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->routeIs('kelas') ? 'active' : '' }}" href="{{ route('kelas') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>kelas</title>
                            <g id="kelas" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <a class="nav-link {{ request()->routeIs('guru') ? 'active' : '' }} " href="{{ route('guru.index') }}">
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>guru</title>
                            <g id="guru" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Master Guru</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ request()->routeIs('siswa') ? 'active' : '' }}" href="{{ route('siswa.index') }}">
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>siswa</title>
                            <g id="siswa" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
